...
public class SecondTypeController {
    ...
    @ResponseBody
    public  List<SecondTypeVO> getType2ByTypeId(HttpServletRequest request,String  type_id) {
        List<SecondTypeVO> list=secondTypeService.getType2ByTypeId(Integer.parseInt(type_id));
        if(list.size()==0){
            return null;
        }
