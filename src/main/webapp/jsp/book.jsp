    ...
    <div class="panel admin-panel">
        ...
        <table class="table table-hover text-center">
            ...
            <tr>
                ...
                <td>2016-07-01</td>
                <td><div class="button-group"> <a class="button border-main" href="cateedit.jsp"><span class="icon-edit"></span> 修改</a> <a class="button border-red" href="javascript:void(0)" onclick="return del(1,2)"><span class="icon-trash-o"></span> 删除</a> </div></td>            </tr>
            <tr>
                <td><input type="checkbox" name="id[]" value="1" />
                    1</td>
                <td>神夜</td>
